...
class Store extends Component {
  ...
  componentDidMount(){
	...
	onPageChanged = data => {
		const { live_tests } = this.state;
		const { currentPage, totalPages, itemsPerPageLimit } = data;
		//console.log("Inside onPageChanged Data", {data});
  ...
  //  });
    ...
    const current_tests = live_tests.slice(offset, offset + itemsPerPageLimit);
		//console.log("Inside onPageChanged current Tests:", current_tests);
		this.setState(this.state.currentPage=Object.assign(currentPage));
		this.setState(this.state.current_tests=Object.assign(current_tests));
		this.setState(this.state.totalPages=Object.assign(totalPages));
		//console.log("Inside onPageChanged State:", this.state.current_tests);
	}
